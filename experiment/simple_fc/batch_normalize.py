...
class FCBatchNormalize(nn.Module):
    """
    Simple Fully-Connected Network with BatchNormalization, 
...
class FCBaselineBatchNormalize(LightningModule):
    def __init__(self, args):
        super().__init__()
        self.args = args
        self.model = FCBatchNormalize(args.model)
        self.mse = nn.MSELoss()
